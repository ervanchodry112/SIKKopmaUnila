        ...
        <div class="row mb-3">
            <div class="col-6">
                ...
                <div class="form-floating-sm text-muted input-group">
                    <input type="text" class="form-control" name="nomor_anggota" id="nomor_anggota" value="<?= $nomor ?>" readonly>
                </div>
            </div>
            <div class="col-6">
                <label for="poin" class="ms-2">Poin</label>
                <div class="form-floating-sm text-muted input-group">
                    <input type="text" class="form-control" name="poin" id="poin" value="<?= $poin ?>">
